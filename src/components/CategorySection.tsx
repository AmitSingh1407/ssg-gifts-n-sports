...
import { 
  Gift, 
  ShoppingBag, 
  Dumbbell, // Replacing Tennis with Dumbbell
  FlagTriangleRight, 
  Gamepad2,
  Beer,
  Plane // Using Plane instead of Drone
} from "lucide-react";
...
const categories = [
  ...
  },
  {
    id: 2,
    name: 'Cricket Gear',
    icon: <Dumbbell className="w-10 h-10" />, // Using Dumbbell icon instead of Tennis
  ...
  },
  {
    id: 3,
    name: 'Drones',
    icon: <Plane className="w-10 h-10" />, // Using Plane icon
